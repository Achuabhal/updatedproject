...
const AddFriend = () => {
  const { fetchFilteredUsers, isUserLoading } = useChatStore();
  ...
  useEffect(() => {
    fetchFilteredUsers()
      .then((data) => setUsers(data.filteredUsers))
  ...
  const handleAddFriend = async (friendId) => {
    ...
    try {
      ...
      setRequestedUsers((prev) => new Set([...prev, friendId])); // Update requested state
